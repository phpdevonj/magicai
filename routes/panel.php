...
use App\Http\Controllers\Dashboard\GoogleAdsenseController;
    ...
    Route::prefix('dashboard')->middleware('auth')->name('dashboard.')->group(function () {
        ...
        Route::prefix('admin')->middleware('admin')->name('admin.')->group(function () {
            ...
            Route::prefix('adsense')->name('adsense.')->group(function () {
                ...
                Route::get('/{id}/edit', [GoogleAdsenseController::class, 'edit'])->name('edit');
                Route::post('/{id}/update', [GoogleAdsenseController::class, 'update'])->name('update');
            });
